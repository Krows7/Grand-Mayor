...
void __fastcall__ multi_vram_buffer_horz(const unsigned char * data, unsigned char len, int ppu_address);


// to push multiple writes as one sequential vertical write to the vram_buffer
void __fastcall__ multi_vram_buffer_vert(const unsigned char * data, unsigned char len, int ppu_address);
